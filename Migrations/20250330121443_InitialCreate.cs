    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Classes__CB1927A0EDD320BF", x => x.ClassID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoomID = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rooms__32863919FAB17ABA", x => x.RoomID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerId = table.Column<string>(type: "varchar(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Courses_CourseCode",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LecturerID = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Lecturer__5A78B91DE69E3492", x => x.LecturerID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ClassID = table.Column<int>(type: "int", nullable: false),
                    ClassIDInt = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SemesterPhase = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    DayOfWeek = table.Column<int>(type: "int", nullable: true),
                    StartPeriod = table.Column<int>(type: "int", nullable: true),
                    NumPeriods = table.Column<int>(type: "int", nullable: true),
                    RoomID = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    LecturerId = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    LecturerId1 = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Timetables_Courses_CourseCode",
                        column: x => x.CourseCode,
                        principalTable: "Courses",
                        principalColumn: "CourseCode",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceCode = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    ...
                    AttendanceMethod = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseEnrollments_CourseCode_StudentId",
                table: "CourseEnrollments",
                columns: new[] { "CourseCode", "StudentId" },
                unique: true);
